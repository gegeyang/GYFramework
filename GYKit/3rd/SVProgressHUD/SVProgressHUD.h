...
@property (assign, nonatomic) NSTimeInterval minimumDismissTimeInterval;            // default is 1.0 seconds
...
@property (copy, nonatomic) SVProgressHUDDismissCompletion dismissCompletion; // default nil

+ (void)setDefaultStyle:(SVProgressHUDStyle)style;                  // default is SVProgressHUDStyleLight
+ (void)setDefaultMaskType:(SVProgressHUDMaskType)maskType;         // default is SVProgressHUDMaskTypeNone
+ (void)setDefaultAnimationType:(SVProgressHUDAnimationType)type;   // default is SVProgressHUDAnimationTypeFlat
+ (void)setMinimumSize:(CGSize)minimumSize;                         // default is CGSizeMake(100.0f, 100.0f), can be used to avoid resizing for a larger message
...
+ (void)setDismissCompletion:(SVProgressHUDDismissCompletion)dismissCompletion;      // default nil
